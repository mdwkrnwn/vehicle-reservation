...
<body class="nav-fixed">
    <nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white"
        ...
        <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="{{ route('admin.home') }}">Vehicle Reservation System</a>
        <!-- Navbar Search Input-->
            ...
            <nav class="sidenav shadow-right sidenav-light">
                <div class="sidenav-menu">
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        <a class="nav-link collapsed" href="{{ route('admin.vehicle.index') }}">
                        ...
                        <a class="nav-link collapsed" href="{{ route('admin.driver.index') }}">
                            <div class="nav-link-icon">
                        ...
                        <a class="nav-link collapsed" href="{{ route('admin.vehicle-booking.index') }}">
                            <div class="nav-link-icon">
                        ...
                        <a class="nav-link collapsed" href="{{ route('admin.report.vehicle-booking') }}">
                            <div class="nav-link-icon">

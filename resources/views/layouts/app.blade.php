...
<head>
    ...
    <title>@yield('title', 'Dashboard - Vehicle Reservation System')</title>
...
<body class="nav-fixed">
    <nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white"
        ...
        <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="{{ route('home') }}">Aplikasi Pendataan Nilai</a>
        <!-- Navbar Search Input-->
            ...
            <nav class="sidenav shadow-right sidenav-light">
                <div class="sidenav-menu">
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        <div class="sidenav-menu-heading mb-20">Log Sistem</div>
                        <a class="nav-link collapsed" href="#">
                            <div class="nav-link-icon"><i data-feather="user"></i></div>
                            Aktivitas User
                            <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
        ...
        <div id="layoutSidenav_content">
            ...
            <footer class="footer-admin mt-auto footer-light">
                <div class="container-xl px-4">
                    <div class="row">
                        <div class="col-md-6 small">Copyright &copy; Aplikasi Pendataan Nilai
                            2025</div>
